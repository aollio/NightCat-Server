...
public class TestData extends BaseObject {
    ...
    private void saveProjects() {
        ...
        for (int i = 0; i < 10; i++) {
            ...
            com.yemao.projects.models.Project project = new com.yemao.projects.models.Project();
            project.setArea(i + 5);
            project.setId("com/yemao/projects" + i);
            ...
            com.yemao.projects.models.ProjectImage proectImage = new ProjectImage();
            proectImage.setId(uuid());
            proectImage.setProj_id("com/yemao/projects" + i);
