...
import static com.yemao.common.ErrorCode.SYSTEM_PERSISTENT_INCORRECT_KEY;
...
//        System.out.println(Collections.);
    ...
    public DefaultQuery<T> queryDefault() {
        return new DefaultQuery<T>(getCriteria());
    }


    public static class DefaultQuery<ENTITY> extends Query<ENTITY, DefaultQuery<ENTITY>> {

        public DefaultQuery(Criteria criteria) {
            super(criteria);
        }

        @Override
        public DefaultQuery getThis() {
            return this;
        }
    }

    public static abstract class Query<ENTITY, RETURN extends Query<ENTITY, RETURN>> {
        ...
        public abstract RETURN getThis();
